        ...
        />
           ...
           ₹{data.price}
            ...
            ">
                       ...
                       <button onClick={()=> dispatch(setAddToCart(
                         { id: data._id, 
                         name: data.name,
                          price: data.price,
                           image: data.image,
                            ...
                            quantity,
                             ...
                             className={`${cartItems.some(i=>i.id==data._id)?"bg-orange-100":"bg-orange-300"} px-2 py-1 hover:bg-orange-400 active:-translate-0.5 transition-all`}> <MdAddShoppingCart size={18} />
                        </button>
                    </div>
                </div>
